...
hooks:
  ...
  Stop:
    - hooks:
        - type: command
          command: "SD=\"${CLAUDE_SKILL_DIR:-${CLAUDE_PLUGIN_ROOT:-$HOME/.claude/skills/planning-with-files}}/scripts\"; if [ -f \"$SD/check-complete.sh\" ]; then sh \"$SD/check-complete.sh\"; fi"
metadata:
  version: "2.30.0"
---
